...
from stripe_proto.settings.utils import get_logger_config
...
SECRET_KEY = os.environ.get('STRIPE_PROTO_SECRET_KEY', 'insecure-secret-key')
...
ROOT_URLCONF = 'stripe_proto.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'stripe_proto.wsgi.application'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': (
                ...
                'stripe_proto.apps.core.context_processors.core',
            ),
...
SESSION_COOKIE_NAME = 'stripe_proto_sessionid'
CSRF_COOKIE_NAME = 'stripe_proto_csrftoken'
LANGUAGE_COOKIE_NAME = 'stripe_proto_language'
