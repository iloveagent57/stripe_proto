...
from stripe_proto.settings.base import *
from stripe_proto.settings.utils import get_env_setting
...
# This may be overridden by the YAML in stripe_proto_CFG,
# but it should be here as a default.
MEDIA_STORAGE_BACKEND = {}
FILE_STORAGE_BACKEND = {}

if 'STRIPE_PROTO_CFG' in environ:
    CONFIG_FILE = get_env_setting('STRIPE_PROTO_CFG')
