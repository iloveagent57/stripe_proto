...
"""
stripe_proto documentation build configuration file.
...
VERSION = get_version('../stripe_proto', '__init__.py')
...
project = 'stripe_proto'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'stripe_proto'
...
html_context = {
    ...
    "github_repo": 'stripe_proto',  # Repo name
...
#
# html_title = 'stripe_proto v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'stripe prototype',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'stripe_proto'),
                os.path.join(root_path, 'stripe_proto/migrations')])
